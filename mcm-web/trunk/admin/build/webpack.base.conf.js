...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      '@a': resolve('src/admin'),
      '@acp': resolve('src/admin/components'),
      '@f': resolve('src/filiale'),
      '@fcp': resolve('src/filiale/components'),
      '@w': resolve('src/warehouse'),
      '@wcp': resolve('src/warehouse/components')
    }
  },
  module: {
    rules: [
