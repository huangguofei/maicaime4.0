	...
	<div class="left set-item">
		...
		<el-table
		    ...
		    <el-table-column
		      ...
		      width="240">
		       <template slot-scope="scope">
		       	<p>{{scope.row.productName}}{{scope.row.sellProductTypeId==2?'('+scope.row.specName+')':''}}</p>
		       	 </template>
		    </el-table-column>
		    <el-table-column
		      prop="settleUnit"
...
export default{
	...
	created () {
		this.taskAction.getSalesProdList()
	},
	methods: {
		currentChange (page) {
